...
//    public static Vector2d BLUE_LEFT_ZONE1_POSITION = new Vector2d(36, 35);//Not set
...
//    public static Vector2d BLUE_RIGHT_ZONE1_POSITION = new Vector2d(-35.6, 35.3);//Not set
...
//    public static Pose2d BLUE_RIGHT_ZONE3_POSITION = new Pose2d(36, -60, Math.toRadians(-180)); //Not set
    ...
    public static Vector2d RED_LEFT_JUNCTION_POSITION = new Vector2d(-30, -2);
    public static Pose2d RED_LEFT_SIDE_STACK_POSITION = new Pose2d(36, -60, Math.toRadians(-180)); //Not set
//    public static Vector2d RED_LEFT_ZONE1_POSITION = new Vector2d(-35, -35); //Not set
...
//    public static Vector2d RED_RIGHT_ZONE1_POSITION = new Vector2d(36, -35);//Not set
